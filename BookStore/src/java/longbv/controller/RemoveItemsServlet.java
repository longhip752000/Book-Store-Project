...
public class RemoveItemsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String[] removeBookIds = request.getParameterValues("removeBookIds");
        
        //System.out.println("->" + Arrays.toString(removeBookIds));
        ...
        for (String removeBookId : removeBookIds) {
            cart.removeFromCart(removeBookId);
        }
        
        response.sendRedirect(VIEW_CART_CONTROLLER);
    }
